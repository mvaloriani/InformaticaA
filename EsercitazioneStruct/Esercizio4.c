...
dichiarazioni di ulteriori variabili e tipi, che copi nella parte iniziale
del vettore personeScelte (senza lasciare buchi):
le persone che parlano inglese con un livello superiore a 3 
oppure hanno non meno di una laurea e un numero di anni di esperienza non inferiore a tre.
*/
...
int main(){
	...
	for(iPersone=0; iPersone<40; iPersone++) {
		...
		if (persone[iPersone].nLauree>=1 && persone[iPersone].anniEsperienza>=3){
			...
			//avanzo l'indice delle persone scelte
			iPersoneScel++;
		} 
