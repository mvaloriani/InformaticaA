...
Le squadre sono 6, di ogni squadra si devono memorizzare: matricola squadra,
nome, città e tutti giocatori come nome e numero di maglia.
Quanta memoria occupa questa struttura?
Scrivere una funzione che riceve in ingresso
la struttura definita e stampa l’elenco dei portieri titolari.
