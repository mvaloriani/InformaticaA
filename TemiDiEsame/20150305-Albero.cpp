/*
L’albero della cuccagna è un albero binario definito come segue 
(pieno di premi, descritti da una stringa):
*/
typedef struct nd {
	char premio[30];
	struct nd* sx, * dx;
...
Se nel corso della ricerca la stringa suggerisce uno spostamento verso un
ramo inesistente,si "cade".

Si codifichi in C una funzione void arrampica( Albero t, char * codice )
che stampa il premio vinto, oppure il messaggio "Non hai vinto" 
se il codice porta a una posizione non valida.
