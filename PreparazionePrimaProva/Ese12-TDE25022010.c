...
cui saltare. Se/quando le coordinate lette indicano un punto esterno al tappeto, 
la pulce scende (applausi)
Si implementino le seguenti funzioni in C e si spieghi brevemente come funzionano 
gli algoritmi usati.
...
int ciclico(TappetoElastico tappeto){
	...
	while (saltoFuori(tappeto[r][c]) && ciclo == 0){
