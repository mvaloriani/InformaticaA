...
intero, da interpretarsi come valore di verità,
che indica se le parole sono anagrammi, cioè se
è possibile ottenere l’una dall’altra tramite
...
int main() {
	...
	if (len != strlen(b))
		si = 0; // non possono essere anagrammi se la lunghezza è diversa
